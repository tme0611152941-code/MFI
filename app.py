...
# --------------------------------------------------
# 3. ระบบ Sound Effects & SFX (รองรับ Safari/iPad)
# --------------------------------------------------
def play_sound(sound_type):
    sounds = {
        "wake_up": "https://actions.google.com/sounds/v1/alarms/alarm_clock.ogg",
        "action_done": "https://actions.google.com/sounds/v1/beeps/short_beep_high.ogg",
        "night_bg": "https://actions.google.com/sounds/v1/weather/rain_heavy.ogg",
        "gameover": "https://actions.google.com/sounds/v1/cartoon/clapping.ogg"
    }
...
# ==================================================
    ...
    # สต็อกข้อมูลการ์ดตัวละคร + รูปภาพอาร์ตเวิร์ก
    role_database = {
        'Werewolf': {
...
# ==================================================
    ...
    # --- 🔮 หมอดู ---
        ...
        if seer_alive:
            check_target = st.selectbox("เลือกคนที่ต้องการส่องดูบทบาท:", st.session_state.players, key="seer_choice")
            if st.button("🔍 ตรวจสอบบทบาท"):
                t_idx = st.session_state.players.index(check_target)
                if st.session_state.roles[t_idx] == 'Werewolf':
                    st.error(f"🔍 ผลการตรวจ: **{check_target}** เป็น 🐺 หมาป่า!")
                else:
    ...
    # ==================================================
        ...
        play_sound("wake_up") # ⏰ เสียงนาฬิกาปลุกดังลั่น iPad
